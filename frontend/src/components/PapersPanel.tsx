...
interface PapersPanelProps {
  ...
  onPaperSelect?: (paperIndex: number) => void;
}
...
export function PapersPanel({ papers, query, selectedPaperId = null, onPaperSelect }: PapersPanelProps) {
            ...
            return (
              <div
                ...
                className={`glass-panel rounded-lg p-4 hover:shadow-elevated transition-all duration-200 cursor-pointer group animate-fade-in-up ${
                  selectedPaperId === paperIndex ? 'ring-2 ring-primary/60 shadow-elevated' : ''
                }`}
              >
