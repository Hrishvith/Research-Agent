...
router.post("/request-otp", async (req, res) => {
  try {
    ...
    console.error("[auth] otp request failed:", err?.message || err);
...
router.post("/verify-otp", async (req, res) => {
  try {
    ...
    console.error("[auth] otp verification failed:", err?.message || err);
...
router.get("/me", auth, async (req, res) => {
  try {
    ...
    console.error("[auth] me lookup failed:", err?.message || err);
